...
test_loader = DataLoader(test_dataset, batch_size =  batch_size, shuffle=False) #, num_worker
...
for sample_num in samples1:
  ...
  plt.axis('off')
plt.savefig('cnn_results1_V2.png')
...
for sample_num in samples2:
  ...
  plt.imshow(output_img,cmap='gray')
  plt.axis('off')
plt.savefig('cnn_results2_v2.png')